...
After we have defined all of the necessary parameters for running secsse_ml, we can start running our analysis and saving them to an R data file, for example, here called output.RDS.
Note that this may take a while and procude a lot of console output.
